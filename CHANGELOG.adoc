...
* The three Spring Boot based projects: `bitcoinj-daemon`, `bitcoinj-peerserver`, and `jc-nmc-daemon` were not pushed to Bintray as part of the release process due to a Gradle plugin configuration issue.
