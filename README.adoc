...
* Modules used by https://namecoin.org/2018/04/03/consensusj-0.2.7-binaries.html[ConsensusJ-Namecoin] use Java 7.
* Most other modules are now using Java 8.
...
|<<cjbtc-jsonrpc,cjbtc-jsonrpc>>
| 7
| not ready yet
| Java JSON-RPC Bitcoin client

|<<cjbtc-jsonrpc-gvy,cjbtc-jsonrpc-gvy>>
| 8
| not ready yet
...
|7
|Optional + tests
|Bitcoin JSON-RPC integration tests, NMC & ETH clients
