...
* The server and command-line tools/libraries now require *Java 11* or later (and will require Java 11 or later after https://github.com/ConsensusJ/consensusj/issues/55[Issue #55: JavaDoc won't build on JDK 11] is resolved.)
