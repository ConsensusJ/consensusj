...
image:https://github.com/ConsensusJ/consensusj/workflows/Build/badge.svg["GitHub Actions Build", link="https://github.com/ConsensusJ/consensusj/actions/workflows/build.yml"]
image:https://gitlab.com/ConsensusJ/consensusj/badges/master/pipeline.svg[link="https://gitlab.com/ConsensusJ/consensusj/pipelines",title="pipeline status"]
...
* A *Groovy* JSON-RPC client that can use _dynamic_ methods for scripting, experimentation and functional testing of _any_ JSON-RPC server.
...
|<<consensusj-jrpc-echod, consensusj-jrpc-echod>>
| *17*
| n/a
...
To build a native image and run:
    ...
    ./consensusj-jrpc-echod/build/native/nativeCompile/jrpc-echod
